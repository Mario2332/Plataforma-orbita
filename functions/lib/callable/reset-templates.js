 ...
 */
exports.resetTemplates = functions
    ...
    try {
        ...
        // Contar tópicos
        const extensiveTopics = extensiveData?.cycles.reduce((sum, c) => sum + c.subjects.reduce((s, sub) => s + sub.topics.length, 0), 0);
        const intensiveTopics = intensiveData?.cycles.reduce((sum, c) => sum + c.subjects.reduce((s, sub) => s + sub.topics.length, 0), 0);
...
//# sourceMappingURL=reset-templates.js.map